...
export default function ListingCard({ listing }: ListingCardProps) {
    return (
          <Link
                  ...
                  className="group flex flex-col rounded-2xl border border-gray-100 bg-white shadow-sm transition hover:shadow-md hover:border-brand-gold/40"
                >
                <div className="relative h-40 w-full overflow-hidden rounded-t-2xl bg-gradient-to-br from-brand-navy/10 to-brand-blue/10">
                        <div className="absolute inset-0 flex items-center justify-center text-brand-navy/20 text-4xl font-extrabold">
                                  BDSN
                        </div>div>
                ...
                <div className="flex flex-1 flex-col p-5">
                        ...
                        <div className="mt-1.5 flex items-center gap-1 text-xs text-gray-500">
                                  ...
                                  <span>{listing.city}, {listing.state}</span>span>
                        </div>div>
