...
export const metadata: Metadata = {
  ...
  description:
    "Explore youth sports trainers, 7v7 teams, flag football leagues, recruiting events, showcases, and NIL resources.",
...
export default function DirectoryPage() {
  ...
  const structuredData = {
    ...
    name: "BDSN Directory",
    description:
      "Browse youth sports programs, events, and NIL resources by category and location.",
    url: "/directory",
  };
